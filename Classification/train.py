...
def load_config(xml_path):
    ...
    parser.add_argument('--config', type=str,default='configs/imagenet/'+ xml_path)
...
def main():
    ...
    xml_paths = os.listdir('./configs/imagenet/')
    ...
    for xml_path in xml_paths:
        ...
        preds, probs, labels, loss, acc = evaluate(config, model,val_loader)
