...
config.train.val_period = 50
config.train.val_ratio = 0.0
config.train.use_test_as_val = True

config.train.output_dir = 'experiments/ricap'
config.train.log_period = 100
config.train.checkpoint_period = 50

config.train.use_tensorboard = True
config.tensorboard = ConfigNode()
config.tensorboard.train_images = True
config.tensorboard.val_images = True
...
config.train.dataloader.num_workers = 0
...
config.validation.dataloader.num_workers = 0
...
config.test.checkpoint = r'.\experiments\imagenet\vgg16\base\checkpoint_00050.pth'
config.test.output_dir = ''
config.test.batch_size = 1
# test data loader
config.test.dataloader = ConfigNode()
config.test.dataloader.num_workers = 0
