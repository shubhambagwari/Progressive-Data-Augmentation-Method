...
def create_dataloader(
    ...
    if is_train:
        ...
        val_loader = torch.utils.data.DataLoader(
            ...
            worker_init_fn=worker_init_fn)
        print("train Class:",train_dataset.classes)
        print("train class_to_idx:", train_dataset.class_to_idx)
        print("val Class:", val_dataset.classes)
        print("val class_to_idx:", val_dataset.class_to_idx)
        return train_loader, val_loader
    else:
        dataset = create_dataset(config, is_train)
        print("test Class:",dataset.classes)
        print("test class_to_idx:", dataset.class_to_idx)
